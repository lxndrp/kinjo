...
/**
 * Provides common access to service discovery handlers (threads) to allow other
 * non-transport specific classes to set a sink for the discovered results.
 * 
...
public interface DiscoveryHandler
	...
	/**
	 * Sets the result sink for this service discovery handler.
	 * 
	 * @param s
	 *            The sink where the results are put into.
	 */
