...
/**
 * This exception is thrown to indicate that a {@link TransportDescriptor} could
 * not be instantiated.
 * 
 * @author Alexander Papaspyrou
 * @version $Revision$, $Date$
 */
final public class MalformedTransportException
		extends Exception {
	 ...
	 */
	private static final long serialVersionUID = -4539430487084451192L;
	 ...
	 *            The detail message.
	 */
	public MalformedTransportException(String message) {
		super( message );
	}
	 ...
	 *            unknown.)
	 */
	public MalformedTransportException(Throwable cause) {
	 ...
	 *            unknown.)
	 */
	public MalformedTransportException(String message, Throwable cause) {
		super( message, cause );
	}
}
