...
/**
 * This exception is thrown to indicate that the registration of a service
 * failed.
 * 
 * @see com.wallabystreet.kinjo.common.transport.protocol.jxta.JXTAPeer
 * @author Alexander Papaspyrou
 * @version $Revision$, $Date$
 */
final public class RegistrationFailureException
		extends Exception {
	 ...
	 */
	private static final long serialVersionUID = -1526463782502484161L;
	...
	public RegistrationFailureException(Throwable cause) {
		super( "failed to register service", cause );
	}
